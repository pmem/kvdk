...
path_report = "./results-hashes-n_threads-{}-sz_key-{}-sz_value-{}-n_collections-{}-timestamp-{}/".format(
    n_thread, 
    sz_key,
    sz_value,
    n_collections,
...
if __name__ == "__main__":
    ...
    para_common = "-type=hashes -value_size={} -threads={} -max_write_threads={} -time={} -path={} -num={} -space={} -collections={}".format(
        sz_value,
        n_thread_total,
        n_thread_write,
        t_duration,
