...
if __name__ == "__main__":
    ...
    bench_queues.run_bench_mark(n_thread=n_thread, sz_value=sz_value, t_duration=t_duration, populate_if_fill=populate_if_fill, sz_pmem_file=sz_pmem_file, sz_fill_data=sz_fill_data, n_collection=n_collection)
