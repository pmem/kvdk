//
// Created by zhanghuigui on 2021/11/3.
//
...
DEFINE_string(rocksdb_path, "/mnt/pmem0/rocksdb", "The path of the rocksdb.");
DEFINE_int64(rocksdb_block_cache_size, 42949672960, "The size of the block cache.");
...
RocksEngine::RocksEngine(const std::string &db_path) {
	...
	table_options.block_cache = rocksdb::NewLRUCache(FLAGS_rocksdb_block_cache_size); // 40G blockcache size
