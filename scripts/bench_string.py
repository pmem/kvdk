...
def run_bench_mark(
    ...
    path_report = "./results-string-threads-{}-key-{}-value-{}-collections-{}-timestamp-{}-commit-{}/".format(
        n_thread, 
        sz_key,
        sz_value,
        n_collection,
    ...
    para_shared = "-type=string -value_size={} -threads={} -max_write_threads={} -time={} -path={} -num={} -space={} -collections={}".format(
        sz_value,
        n_thread_total,
        n_thread_write,
        t_duration,
    ...
    # batch insert
    new_para = para_shared + " -fill=0 -read_ratio=0 -batch=100 -existing_keys_ratio=0"
