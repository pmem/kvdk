...
template <typename IntType = int> class zipfian_distribution
{
  ...
  public:
    inline zipfian_distribution(result_type n, float_type e = default_s) : N{n}, s{e}
    {
    ...
    template <typename UniformBitRandomGenerator> inline result_type operator()(UniformBitRandomGenerator &g) const
    {
