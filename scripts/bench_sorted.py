...
def run_bench_mark(
    ...
    path_report = "./results-sorted-threads-{}-key-{}-value-{}-collections-{}-commit-{}-timestamp-{}/".format(
        n_thread, 
        sz_key,
        sz_value,
        n_collections,
    ...
    para_shared = "-type=sorted -value_size={} -threads={} -max_write_threads={} -time={} -path={} -num={} -space={} -collections={}".format(
        sz_value,
        n_thread_total,
        n_thread_write,
        t_duration,
